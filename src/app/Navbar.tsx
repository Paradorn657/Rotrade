                ...
                {navigation.map((item) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <button className="btn btn-primary btn-sm mr-5 hover:text-white hover:bg-blue-300">Login</button>
                        <button  className="btn btn-primary btn-sm mr-5 hover:text-white hover:bg-blue-300" ><Link href="/signup">Sign up</Link></button>
                        <button
                            type="button"
